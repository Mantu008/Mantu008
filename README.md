...
🌐 **Portfolio:** [professional-portfolio-gamma.vercel.app](https://professional-portfolio-gamma.vercel.app)

---

## 🚀 About Me

I am a passionate **Full Stack Developer** with experience in designing, developing, and maintaining web applications. My expertise includes both frontend and backend development using modern technologies and frameworks.
...
<img src="https://static-00.iconduck.com/assets.00/hono-icon-512x512-ls7zv57x.png" alt="Hono" width="40" height="40"/>
<br/>

<!-- Databases -->
<img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/mongodb/mongodb-original-wordmark.svg" alt="MongoDB" width="40" height="40"/>
<img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/mysql/mysql-original-wordmark.svg" alt="MySQL" width="40" height="40"/>
<img src="https://mariadb.com/wp-content/uploads/2019/11/mariadb-logo-vert_blue-transparent.png" alt="MariaDB" width="40" height="35"/>
<br/>
...
<!-- Auth -->
<img src="https://avatars.githubusercontent.com/u/64521828?s=200&v=4" alt="NextAuth.js" width="40" height="40"/>
...
A hotel booking frontend that lists hotels with detailed specifications, amenities, and filtering options.  
🔗 [Live Demo](https://web-horizon-hackthone.vercel.app/)  
**Tech Stack:** React, React Router, Tailwind CSS, Axios, React Icons

---

### 🔐 [Next.js & Authentication with NextAuth.js](https://github.com/Mantu008/NEXT-AUTH-V5)  
Secure authentication using Google, GitHub, and credentials login. Session protection and route security included.  
🔗 [Live Demo](https://next-auth-v5-six-lake.vercel.app/)  
**Tech Stack:** Next.js, NextAuth.js

---

### 👟 [KiteFoot - Shoe E-Commerce Website](https://github.com/Mantu008/Shoes-E_Comm)  
Shoe e-commerce site with category-wise listings and a modern UI.  
...
Full-featured backend with CRUD operations and secure session management using JWT.  
🔗 [Frontend Demo](https://e-commerce-mern-frontant.vercel.app/)  
**Tech Stack:** Node.js, Express.js, MongoDB, React

---

### 📦 [Matrix - Product Packing Management System](https://github.com/Mantu008/product)  
Automates product-to-box assignments and generates labeled packing PDFs, reducing processing time by 15%.  
🔗 [Live Demo](https://vergin-matrix-frontend.vercel.app/)  
🔐 **Demo Login:** `Username: mantu@gmail.com | Password: mantu`  
**Tech Stack:** React.js, Node.js, PDFKit, Optimization Logic

---

## 🎯 Fun Fact

⚡ I love solving coding problems and building interactive UIs that deliver great user experiences!
